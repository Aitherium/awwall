...
interesting failures live BETWEEN them. "awwall is installed" is not the useful
fact -- "awwall is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awwall'
FAMILY = ['awask', 'awavatar', 'awbac', 'awbrain', 'awbrowse', 'awclassify', 'awdecide', 'awdelphi', 'awdit', 'awembed', 'awevolve', 'awfind', 'awflow', 'awfocus', 'awgit', 'awgraph', 'awgym', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awpool', 'awpredict', 'awprism', 'awprove', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrena', 'awrepl', 'awreport', 'awresearch', 'awrise', 'awrouter', 'awrtifact', 'awrun', 'awscreen', 'awseal', 'awsettings', 'awshare', 'awsprite', 'awstorage', 'awswarm', 'awtax', 'awtoll', 'awtunnel', 'awvision', 'awvoice', 'gawbbonet']
PAIRS_WITH = ['awbac', 'awdit', 'adk', 'awiam', 'awnboard', 'awnest', 'awnet', 'awtunnel']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awwall needs at runtime, and a
